...
public class PhCurrencyTest {
	...
	public void test() {
        ...
        for (double testNum : testNumSet) {
            ...
            String numPhPesoStr = formatToPhPesoStr(testNum);

            System.out.println("Test num: " + String.valueOf(testNum));
    		System.out.println("Test num to PhPeso Str: " + numPhPesoStr);
            System.out.println("Test to PhCurrency: " + test.toString());        
            System.out.println("Test2 to PhCurrency: " + test.toString());
    		System.out.println();

            assertEquals(testNum, test.toDouble(), DELTA);
            assertEquals(numPhPesoStr, test.toString());
            assertEquals(test.toDouble(), test2.toDouble(), DELTA);
        }
	}
